...
public class ContratRubrique implements Serializable {
    ...
    @JoinColumn(name = "contrat_bail", referencedColumnName = "id", nullable = false)
    @ManyToOne(optional = false)
    private ContratBail contratBail;
    @JoinColumn(name = "rubrique", referencedColumnName = "id", nullable = false)
    @ManyToOne(optional = false)
