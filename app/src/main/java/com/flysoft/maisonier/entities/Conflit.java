...
public class Conflit implements Serializable {
    ...
    private Integer id;
    @JoinColumn(name = "privilege1", referencedColumnName = "id", nullable = false)
    @ManyToOne(optional = false)
    private Privilege privilege1;
    @JoinColumn(name = "privilege2", referencedColumnName = "id", nullable = false)
    @ManyToOne(optional = false)
